-- This is the default language! 76561198166995699
if CLIENT then
    ...
    slib.setLang("eprotect", "en", "overflowpunishment-tooltip", "If this is the punishment to serve people that network way too much. (1 = kick, 2 = ban)")
    ...
    slib.setLang("eprotect", "en", "bypassgroup-tooltip", "If your usergroup is in this list it cannot be banned by eProtect.")
    ...
    slib.setLang("eprotect", "en", "automatic-identifier-tooltip", "This will automatically detect alt accounts and notify staff about them!")
