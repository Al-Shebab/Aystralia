...
elseif CLIENT then
	...
	slib.setLang("gprotect", "de", "general_removeDisconnectedPlayersEntities", "Entferne Entities von getrennten Spielern")
	slib.setLang("gprotect", "de", "general_removeDisconnectedPlayersEntities_tooltip", "Dies entfernt Entities von getrennten Spielern (deaktiviert falls -1.)")
	...
	slib.setLang("gprotect", "de", "general_maxModelSize", "Maximale Modellgröße")
	slib.setLang("gprotect", "de", "general_maxModelSize_tooltip", "Falls dies größer 0 ist, entfernt es größere Props direkt nach dem Spawn.")
	...
	slib.setLang("gprotect", "de", "spawnrestriction_blockedSENTs", "Blockierte SENTs")
	slib.setLang("gprotect", "de", "spawnrestriction_blockedSENTs_tooltip", "Platziere hier Klassennamen von Entities, welche nie gespawnt werden sollen!")
	slib.setLang("gprotect", "de", "spawnrestriction_blockedEntityIsBlacklist", "Blockierte Klassen sind Blacklist")
	slib.setLang("gprotect", "de", "spawnrestriction_blockedEntityIsBlacklist_tooltip", "Falls aktiviert, dann werden Klassen in der Liste blockiert, ansonsten kannst du nur diese Klassen spawnen.")
