...
ENT.PrintName = "Strawberrys"
ENT.Category = "Zeros FruitSlicer"
ENT.Model = "models/zerochain/fruitslicerjob/fs_strawberry.mdl"
ENT.PrepareAmount = 8
...
function ENT:Interact_VFX_SFX()
    zfs.f.CreateEffectTable("zfs_strawberry",  "zfs_sfx_banana", self, self:GetAngles(), self:GetPos(),nil)
