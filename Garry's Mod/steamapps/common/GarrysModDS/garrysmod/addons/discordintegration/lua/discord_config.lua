Discord.Config = {
	...
	ClientID = '755792927891914812',
	ClientSecret = '5mfqZev_vkGlcIbtiB3koJz-VPvy5vXP',
	...
	BotToken = 'NzU1NzkyOTI3ODkxOTE0ODEy.X2IdAw.STHAvVoEejnCD7e-sxdXX9uScsA',
    ...
    RankSync = {
        ...
        SyncableDiscordRanks = {
            ...
            ['Administrator'] = 'donator-admin',
            ['Administrator'] = 'admin',
            ['Senior Moderator'] = 'donator-senior-moderator',
            ['Senior Moderator'] = 'senior-moderator',
            ['Moderator'] = 'donator-moderator',
            ['Moderator'] = 'moderator',
            ['Trial Moderator'] = 'donator-trial-moderator',
