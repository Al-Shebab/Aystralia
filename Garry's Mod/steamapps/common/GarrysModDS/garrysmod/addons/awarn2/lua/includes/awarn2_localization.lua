...
Available Languages:
	...
	ES		-	Spanish 	- provided by Preston Vasquez (http://steamcommunity.com/profiles/76561198290329975/)
	PL		-	Polish		- provided by Kancer (https://steamcommunity.com/id/stalkershepard/)
]]
...
AWarn.localizations["EN"] = {
	...
	cl26	=		"Allow AWarn to KICK players", --Found in cl_init.lua
	cl27	=		"Allow AWarn to BAN players", --Found in cl_init.lua
...
AWarn.localizations["FIN"] = {
    ...
    cl26    =       "Salli AWarnin poistaa pelaaja", --Found in cl_init.lua
    cl27    =       "Salli AWarnin bannata pelaaja", --Found in cl_init.lua
...
AWarn.localizations["DE"] = {
    ...
    cl26    =       "AWarn das KICKEN von Spielern erlauben", --Found in cl_init.lua
    cl27    =       "AWarn das BANNEN von Spielern erlauben", --Found in cl_init.lua
...
AWarn.localizations["FR"] = {
    ...
    cl26    =       "AWarn peut KICK les joueurs.", --Found in cl_init.lua
    cl27    =       "AWarn peut BAN les joueurs.", --Found in cl_init.lua
...
AWarn.localizations["PT"] = {
    ...
    cl26    =       "Permitir AWarn dar KICK em jogadores", --Found in cl_init.lua
    cl27    =       "Permitir AWarn dar BAN em jogadores", --Found in cl_init.lua
...
AWarn.localizations["NL"] = {
	...
	cl26	=		"Laat AWarn spelers kicken", --Found in cl_init.lua
	cl27	=		"Laat AWarn spelers verbannen", --Found in cl_init.lua
...
--[[
    Spanish translation provided by Preston Vasquez (http://steamcommunity.com/profiles/76561198290329975/)
]]
AWarn.localizations["ES"] = {
	cl1		=		"AWarn Menú", -- Encontrado en cl_init.lua
	cl2		=		"Versión", -- Se encuentra en cl_init.lua
	cl3		=		"Haga clic derecho en un jugador para más opciones!", --Encontrado en cl_init.lua
	cl4		=		"Jugadores Seleccionados Advertencias activas", --Encontrado en cl_init.lua
	cl5		=		"Ganancias totales de los jugadores seleccionados", --Encontrado en cl_init.lua
	cl6		=		"Opciones", --Encontrado en cl_init.lua
	cl7		=		"Advertencia de administrador", --Encontrado en cl_init.lua
	cl8		=		"Razón", --Encontrado en cl_init.lua
	cl9		=		"Cortar", --Encontrado en cl_init.lua
	cl10	=		"Fecha y hora", --Encontrado en cl_init.lua
	cl11	=		"Eliminar advertencia", --Encontrado en cl_init.lua
	cl12	=		"Copiar al portapapeles", --Encontrado en cl_init.lua
	cl13	=		"Motivo de advertencia copiado al portapapeles", --Encontrado en cl_init.lua
	cl14	=		"Nombre del jugador", --Encontrado en cl_init.lua
	cl15	=		"Advertir", --Encontrado en cl_init.lua
	cl16	=		"Claras advertencias", --Encontrado en cl_init.lua
	cl17	=		"Reducir las advertencias activas", --Encontrado en cl_init.lua
	cl18	=		"¡Muestra tus advertencias!", --Encontrado en cl_init.lua
	cl19	=		"Sus advertencias activas: ", --Encontrado en cl_init.lua
	cl20	=		"Sus advertencias totales: ", --Encontrado en cl_init.lua
	cl21	=		"AWarn Menú de advertencia", --Encontrado en cl_init.lua
	cl22	=		"Jugador de advertencia: ", --Encontrado en cl_init.lua
	cl23	=		"ENVIAR", --Encontrado en cl_init.lua
	cl24	=		"CANCELAR", --Encontrado en cl_init.lua
	cl25	=		"Menú de opciones AWarn", --Encontrado en cl_init.lua
	cl26	=		"Permitir que AWarn KICK jugadores", --Encontrado en cl_init.lua
	cl27	=		"Permita que AWarn BAN jugadores", --Encontrado en cl_init.lua
	cl28	=		"Las advertencias activas del jugador decaerán con el tiempo.", --Encontrado en cl_init.lua
	cl29	=		"Se requiere que los administradores presenten un motivo cuando advierten a alguien.", --Encontrado en cl_init.lua
	cl30	=		"Las advertencias activas del jugador se restablecerán después de una prohibición a través de AWarn.", --Encontrado en cl_init.lua
	cl31	=		"Log AWarn Actions a un archivo de datos.", --Encontrado en cl_init.lua
	cl32	=		"Tasa de decaimiento (en minutos)", --Encontrado en cl_init.lua
	cl33	=		"Configuraciones / Configuraciones adicionales de Castigo se pueden encontrar en:", --Encontrado en cl_init.lua
	cl34	=		"fue advertido por", --Encontrado en cl_init.lua
	cl35	=		"prevenido", -- Encontrado en cl_init.lua / sv_init.lua
	cl36	=		"¡Asegúrese de envolver el steamID entre comillas!", --Encontrado en cl_init.lua / sv_init.lua
	cl37	=		"¡Jugador no encontrado!", --Encontrado en cl_init.lua / sv_init.lua
	
	sv1		=		"Usted no tiene acceso a este comando.", --Encontrado en sv_init.lua
	sv2		=		"No puedes configurar este CVar con este comando.", --Encontrado en sv_init.lua
	sv3		=		"Debe pasar este ConVar un valor positivo.", --Encontrado en sv_init.lua
	sv4		=		"No puedes avisar a otros administradores.", --Encontrado en sv_init.lua
	sv5		=		"DEBES incluir una razón. Deshabilita esto en las opciones.", --Encontrado en sv_init.lua
	sv6		=		"Usted ha sido advertido por", --Encontrado en sv_init.lua
	sv7		=		"Tipo! Advierte para ver una lista de tus advertencias.", --Encontrado en sv_init.lua
	sv8		=		"¡Este comando no se puede ejecutar desde la consola del servidor!", --Encontrado en sv_init.lua
	sv9		=		"¡Este jugador no puede ser advertido!", --Encontrado en sv_awarn.lua
	sv10	=		"¡Los jugadores en este grupo no pueden ser advertidos!", --Encontrado en sv_awarn.lua
	
	sql1	=		"fue expulsado por alcanzar el umbral de advertencia", --Encontrado en awarn_sql.lua
	sql2	=		"fue prohibido por alcanzar el umbral de advertencia", --Encontrado en awarn_sql.lua
	sql3	=		"Este jugador no tiene advertencias registradas", --Encontrado en awarn_sql.lua
	sql4	=		"Advertencias reducidas en 1 para el jugador: ", --Encontrado en awarn_sql.lua
	sql5	=		"Este jugador ya tiene 0 advertencias activas", --Encontrado en awarn_sql.lua
	sql6	=		"Borró todas las advertencias para el jugador", --Encontrado en awarn_sql.lua
	sql7	=		"Registre para este ID de advertencia no encontrado", --Encontrado en awarn_sql.lua
	sql8	=		"Bienvenido de nuevo al servidor", --Encontrado en awarn_sql.lua
	sql9	=		"Advertencias activas actuales", --Encontrado en awarn_sql.lua
	sql10	=		"se une al servidor", --Encontrado en awarn_sql.lua
	sql11	=		"Advertencias totales", --Encontrado en awarn_sql.lua
}


--[[
    Polish translation provided by Kancer (https://steamcommunity.com/id/stalkershepard/)
]]
AWarn.localizations["PL"] = {
    cl1     =       "AWarn Menu", --Found in cl_init.lua
    cl2     =       "Wersja", --Found in cl_init.lua
    cl3     =       "Kliknij prawym przyciskiem na gracza, aby zobaczyć więcej opcji!", --Found in cl_init.lua
    cl4     =       "Ostrzeżenia wybranego gracza", --Found in cl_init.lua
    cl5     =       "Wszystkie ostrzeżenia wybranego gracza", --Found in cl_init.lua
    cl6     =       "Opcje", --Found in cl_init.lua
    cl7     =       "OSTRZEŻENIE WYSTAWIŁ", --Found in cl_init.lua
    cl8     =       "POWÓD", --Found in cl_init.lua
    cl9     =       "SERVER", --Found in cl_init.lua
    cl10    =       "DATA/CZAS", --Found in cl_init.lua
    cl11    =       "Usunięte ostrzeżenia", --Found in cl_init.lua
    cl12    =       "Skopiuj do schowka", --Found in cl_init.lua
    cl13    =       "Powód ostrzeżenia skopiowany do schowka!", --Found in cl_init.lua
    cl14    =       "Nazwa Gracza", --Found in cl_init.lua
    cl15    =       "Ostrzeż", --Found in cl_init.lua
    cl16    =       "Wyczyść Ostrzeżenia", --Found in cl_init.lua
    cl17    =       "Zmniejsz liczbę aktywnych Ostrzeżeń", --Found in cl_init.lua
    cl18    =       "Pokazuje Twoje ostrzeżenia!", --Found in cl_init.lua
    cl19    =       "Twoje aktywne ostrzeżenia: ", --Found in cl_init.lua
    cl20    =       "Wszystkie Twoje ostrzeżenia: ", --Found in cl_init.lua
    cl21    =       "AWarn Menu Ostrzeżeń", --Found in cl_init.lua
    cl22    =       "Ostrzeżenie gracza: ", --Found in cl_init.lua
    cl23    =       "ZATWIERDŹ", --Found in cl_init.lua
    cl24    =       "ANULUJ", --Found in cl_init.lua
    cl25    =       "AWarn Menu OPCJI", --Found in cl_init.lua
    cl26    =       "Pozwól AWarn aby KICKOWAĆ graczy", --Found in cl_init.lua
    cl27    =       "Pozwól AWarn aby BANOWAĆ graczy", --Found in cl_init.lua
    cl28    =       "Aktywne ostrzeżenia gracza z czasem wygasają.", --Found in cl_init.lua
    cl29    =       "Admini muszą podać powód gdy dadzą komuś Ostrzeżenie.", --Found in cl_init.lua
    cl30    =       "Aktywne ostrzeżenia gracza zrestetują się kiedy dostanie bana AWarn.", --Found in cl_init.lua
    cl31    =       "Zapisuje Logi AWarna do folderu data.", --Found in cl_init.lua
    cl32    =       "Szybkość wygaśnięcia ostrzeżenia (w minutach)", --Found in cl_init.lua
    cl33    =       "Dodatkowa Kara opcje/konfiguracja można znaleźć w:", --Found in cl_init.lua
    cl34    =       "został ostrzeżony przez", --Found in cl_init.lua
    cl35    =       "ostrzeżony", --Found in cl_init.lua/sv_init.lua
    cl36    =       "Upewnij aby wpisać STEAMID w cudzysłów!", --Found in cl_init.lua/sv_init.lua
    cl37    =       "Gracz nie znaleziony!", --Found in cl_init.lua/sv_init.lua
    
    sv1     =       "Nie masz uprawnień do tej komendy.", --Found in sv_init.lua
    sv2     =       "Nie możesz zmienić Cvaru tą komendą.", --Found in sv_init.lua
    sv3     =       "Musisz ustawić ConVar jako dodatnią wartość.", --Found in sv_init.lua
    sv4     =       "Nie masz uprawnień, aby dać ostrzeżenie innemu adminowi.", --Found in sv_init.lua
    sv5     =       "Musisz podać POWÓD w ostrzeżeniu. Możesz wyłączyć to w opcjach.", --Found in sv_init.lua
    sv6     =       "Zostałeś ostrzeżony przez", --Found in sv_init.lua
    sv7     =       "Wpisz !warn aby zobaczyć listę ostrzeżeń.", --Found in sv_init.lua/awarn_sql.lua
    sv8     =       "Ta komenda nie może być wprowadzona przez konsolę servera!", --Found in sv_init.lua
    sv9     =       "Ten gracz nie może być ostrzeżony!", --Found in sv_awarn.lua
    sv10    =       "Gracze w tej grupie nie mogą być ostrzeżeni!", --Found in sv_awarn.lua
    
    sql1    =       "został wyrzucony za osiągniecie dopuszczalnego progu ostrzeżeń", --Found in awarn_sql.lua
    sql2    =       "został zbanowany za osiągniecie dopuszczalnego progu ostrzeżeń", --Found in awarn_sql.lua
    sql3    =       "Ten gracz nie ma historii ostrzeżeń", --Found in awarn_sql.lua
    sql4    =       "Ostrzeżenia zmniejszone o 1 dla gracza: ", --Found in awarn_sql.lua
    sql5    =       "W tej chwili ten gracz ma 0 aktywnych ostrzeżeń", --Found in awarn_sql.lua
    sql6    =       "Wyczyszczono ostrzeżenia dla gracza", --Found in awarn_sql.lua
    sql7    =       "Rejestr dla tego ostrzeżenia, nie znaleziono", --Found in awarn_sql.lua
    sql8    =       "Witaj ponownie na serverze", --Found in awarn_sql.lua
    sql9    =       "Obecnie Aktywne Ostrzeżenia", --Found in awarn_sql.lua
    sql10   =       "dołącza na server", --Found in awarn_sql.lua
    sql11   =       "Wszystkie Ostrzeżenia", --Found in awarn_sql.lua
}