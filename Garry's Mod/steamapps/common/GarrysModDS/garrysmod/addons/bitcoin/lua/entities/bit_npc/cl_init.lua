...
surface.CreateFont( "bitmine_font_17", {
	font = "Lato",
	size = 17,
	weight = 500,
	antialias = true
...
surface.CreateFont( "bitmine_font_19", {
	font = "Lato",
	size = 28,
	weight = 500,
	antialias = true
...
local ahshop3_icon1 = Material("materials/bit/icon.png")
...
function ENT:Draw()
	...
	cam.Start3D2D(self:GetPos()+self:GetUp()*79, Angle(0, AhEyes.y-90, 90), 0.08)
		...
		draw.SimpleText( bitmine.HeaderText, "bitmine_font_19", -103, 23, Color( 168, 167, 168, 70 + main ), 0, 1 )
		draw.SimpleText( "Sell me your bitcoin harddisks.", "bitmine_font_17", -120, 51, Color( 113, 111, 113, 70 + main ), 0, 1 )
