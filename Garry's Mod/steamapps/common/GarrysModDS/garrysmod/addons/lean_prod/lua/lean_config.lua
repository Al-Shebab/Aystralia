...
lean_igconfig.sellprice = {val = 15000,name = "Lean Sell Price",category = "General",desc = "How much 1 cup of lean will sell for"}
...
-- Prices
lean_igconfig.sprite_price = {val = 500,name = "Sprite Price",category = "Prices",desc = "How much it costs for 1 sprite"}
lean_igconfig.codeine_price = {val = 250,name = "Codeine Price",category = "Prices",desc = "How much it costs for 1 codeine"}
...
lean_igconfig.ice_price = {val = 100,name = "Ice Cube Price",category = "Prices",desc = "How much it costs for 1 ice cube"}
-- NPC
