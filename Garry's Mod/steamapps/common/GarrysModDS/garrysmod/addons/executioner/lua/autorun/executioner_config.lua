    ...
    Executioner.Config.No_Place_Teams = {}
    ...
    Executioner.Config.Clean_Ranks = { -- Translates a usergroup into a nicer string for the first interface.
        [ 'superadmin' ] = 'Superadmin', [ 'staff-manager' ] = 'Staff Manager', [ 'senior-admin' ] = 'Senior Admin', [ 'admin' ] = 'Admin', [ 'moderator' ] = 'Moderator', [ 'donator-admin' ] = 'Admin', [ 'donator-moderator' ] = 'Moderator', [ 'senior-moderator' ] = 'Senior Moderator', [ 'donator-senior-moderator' ] = 'Senior Moderator',
        [ 'trial-moderator' ] = 'Trial Moderator', [ 'donator-trial-moderator' ] = 'Trial Moderator', [ 'trusted' ] = 'Trusted', [ 'user' ] = 'User', [ 'sydney' ] = 'Sydney', [ 'melbourne' ] = 'Melbourne', [ 'brisbane' ] = 'Brisbane', [ 'perth' ] = 'Perth',
    }
    ...
    Executioner.Config.BonusChance = 0 -- The chance 1 - 100% that a Hitman is offered a bonus.
    ...
    Executioner.Config.Min_Hit_Price = 15000 -- The minimum price the customer can place
    ...
    Executioner.Config.GroupConfiguration = { -- Rank colors in the menu.
        [ 'user' ]		col = Color(93, 24, 255),
        [ 'trusted' ]	col = Color(132, 81, 252),
        [ 'perth' ]		col = Color(0, 183, 212),
        [ 'brisbane' ]		col = Color(61, 229, 255),
        [ 'melbourne' ]		col = Color(61, 255, 213),
        [ 'sydney' ]	col = Color(61, 255, 154),
        [ 'trial-moderator' ]		col = Color(24, 249, 255),
        [ 'moderator' ]		col = Color(74, 255, 121),
        [ 'senior-moderator' ]	col = Color(148, 255, 87),
        [ 'admin' ]	col = Color(226, 255, 68),
        [ 'senior-admin' ]		col = Color(255, 180, 0),
        [ 'staff-manager' ]	col = Color(255, 101, 101),
        [ 'superadmin' ]	col = Color(255, 0, 0),
        [ 'donator-trial-moderator' ]	col = Color(24, 249, 255),
        [ 'donator-moderator' ]	col = Color(74, 255, 121),
        [ 'donator-senior-moderator' ]	col = Color(148, 255, 87),
        [ 'donator-admin' ]   col = Color(226, 255, 68),
    }
