...
CH_ArmoryRobbery.Config.MoneyTimer = 60 -- This is the time that defines when money is added to the armory. In seconds! [Default = 60 (1 Minute)]
...
CH_ArmoryRobbery.Config.MaxMoney = 2500000 -- The maximum amount of money the armory can have. Set to 0 for no limit. [Default = 50000]
...
CH_ArmoryRobbery.Config.AmmoOnTime = 5 -- This is the amount of ammo to be added to the armory every x minutes/seconds. Defined by the setting above. [Default = 5]
...
-- General settings.
CH_ArmoryRobbery.Config.AliveTime = 3 -- The amount of MINUTES the player must stay alive before he will receive what the armory has. IN MINUTES! [Default = 5]
CH_ArmoryRobbery.Config.CooldownTime = 20 -- The amount of MINUTES the armory is on a cooldown after a robbery! (Doesn't matter if the robbery failed or not) [Default = 20]
CH_ArmoryRobbery.Config.RobberyDistance = 300000 -- The amount of space the player can move away from the armory entity, before the robbery fails. [Default = 500]
...
CH_ArmoryRobbery.Config.KillReward = 50000 -- The amount of money a person is rewarded for killing the armory robber. [Default = 2500]
