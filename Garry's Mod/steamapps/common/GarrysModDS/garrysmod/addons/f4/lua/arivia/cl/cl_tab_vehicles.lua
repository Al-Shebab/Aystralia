...
function PANEL:Init( )
    ...
    for i = 0, 0 do
        for k, v in ipairs( CustomVehicles ) do
            ...
            if !mod:bCanBuyVeh(v) then continue end
            ...
            function ListItem:Paint( w, h )
               ...
               -----------------------------------------------------------------
                ...
                if arivia.tab.vehc.bXpEnabled and LevelSystemConfiguration then
                ...
                if LevelSystemPrestigeConfiguration and arivia.tab.vehc.bPrestigeEnabled then
                ...
                if (arivia.tab.vehc.bXpEnabled and ( LevelSystemConfiguration ) ) or (arivia.tab.vehc.bPrestigeEnabled and ( LevelSystemPrestigeConfiguration or v.prestige ) )  then
                    originNameX = 11
                end
                ...
                draw.DrawText( objectName, 'AriviaFontObjectListName', 65, originNameX, arivia.tab.vehc.clr_txt or Color( 255, 240, 244 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER )

                if arivia.tab.vehc.bXpEnabled then
                    if LevelSystemConfiguration then
                        ...
                        if arivia.tab.vehc.bPrestigeEnabled and LevelSystemPrestigeConfiguration then
                            draw.DrawText( prestigeText, 'AriviaFontObjectLevel', 140, 35, Color( 255, 240, 244, 100 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER )
                        end
                    end
                elseif arivia.tab.vehc.bPrestigeEnabled then
...
vgui.Register( 'arivia_tab_veh', PANEL, 'DPanel' )