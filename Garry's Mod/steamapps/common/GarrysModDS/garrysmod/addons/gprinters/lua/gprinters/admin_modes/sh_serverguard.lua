...
gPrinters.adminModes[ "Serverguard System" ] = {
    ...
    addFunction = function( panel )
        ...
        for _, v in pairs( serverguard.ranks:GetStored() ) do
    ...
    editFunction = function( panel, ranks )
        ...
        for _, h in pairs( serverguard.ranks:GetStored() ) do
            if ( ( _ == "operator" ) or ( _ == "noaccess" ) ) then continue end
            local grp = vgui.Create( "DButton", panel )
            grp:SetSize( 160, 25 )
            grp:SetText( "" )
