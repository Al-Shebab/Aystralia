...
VoidCases.CurrentVersion = "2.0.6"
...
hook.Add("Initialize", "VoidCases.LibLoader", function ()
	VoidLib.Tracker:RegisterAddon("VoidCases", "6922", "86480917912377711")
