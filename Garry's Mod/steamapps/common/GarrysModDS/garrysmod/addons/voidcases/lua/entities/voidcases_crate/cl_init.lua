...
matproxy.Add({
    ...
    bind = function (self, mat, ent)
        if (ent:GetNWVector("CrateColor") and isvector(ent:GetNWVector("CrateColor"))) then
...
matproxy.Add({
    ...
    bind = function (self, mat, ent)
        if (ent:GetNWString("CrateLogo") and VoidCases.CachedMaterials[ent:GetNWString("CrateLogo")]) then
