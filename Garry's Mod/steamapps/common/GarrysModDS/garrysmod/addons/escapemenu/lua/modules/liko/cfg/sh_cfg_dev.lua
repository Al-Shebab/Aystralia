...
*/
    ...
    *
    *   this setting MUST be enabled in order for the permission 'liko_motd_canignore' to work
    *
    *   >   true            : users with permission 'liko_motd_canignore' will not see the MOTD when they join the server
