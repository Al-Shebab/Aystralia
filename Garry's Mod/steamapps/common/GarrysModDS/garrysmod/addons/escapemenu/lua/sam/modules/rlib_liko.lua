        ...
        */
        ...
        :OnExecute( function( pl )
            ...
            */
            ...
            rhook.run.rlib( 'liko_rnet_register', pl )
        end )
    :End( )

/*
*   sam > cmd > liko_fonts_reload
*/
        ...
        */
        ...
        :OnExecute( function( pl )
            ...
            */
            ...
            rnet.send.player( pl, 'liko_fonts_reload' )
        end )
    :End( )