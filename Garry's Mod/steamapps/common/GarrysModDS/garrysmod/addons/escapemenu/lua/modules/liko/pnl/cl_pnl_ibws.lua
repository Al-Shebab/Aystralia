...
function PANEL:Init( )
    ...
    */
    ...
    :notext                         (                                       )
    :font                           ( pref( 'ibws_title' )                  )
    :clr                            ( self.cf_d.clrs.header_txt             )

                                    :draw( function( s, w, h )
                                        if not self.title or self.title == '' then self.title = ln( 'browser_untitled' ) end
                                        draw.SimpleText( helper.get:utf8( 'title_a' ), pref( 'ibws_icon' ), 4, 6, self.cf_d.clrs.header_ico, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER )
                                        draw.SimpleText( self.title, pref( 'ibws_title' ), 25, h / 2, self.cf_d.clrs.header_txt, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER )
                                    end )
    ...
    */
    ...
    :ocr                            ( self                                  )
                                    ...
                                    :draw( function( s, w, h )
                                        ...
                                        draw.SimpleText( helper.get:utf8( 'close' ), pref( 'ibws_exit' ), w / 2 - 5, h / 2 + 4, clr_txt, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
                                    end )
...
function PANEL:Paint( w, h )
    ...
    */
    ...
    draw.SimpleText( helper.get:utf8( 'resize' ), pref( 'ibws_resizer' ), w - 3, h - 7, self.cf_d.clrs.ico_resize, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER )
    draw.SimpleText( helper.get:utf8( 'resize' ), pref( 'ibws_resizer' ), w - 5, h - 9, self.cf_d.clrs.body_box, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER )
end
...
function PANEL:GetTitle( )
    local title = ln( 'browser_untitled' )
