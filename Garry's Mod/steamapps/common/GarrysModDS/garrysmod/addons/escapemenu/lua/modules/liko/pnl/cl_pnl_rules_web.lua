...
function PANEL:Init( )
    ...
    */
    ...
    :tooltip                        ( ln( 'tooltip_close_window' )          )
                                    ...
                                    :draw( function( s, w, h )
                                        ...
                                        draw.SimpleText( helper.get:utf8( 'close' ), pref( 'rules_exit' ), w / 2, h / 2 + 4, clr_txt, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
                                    end )
    ...
    */
    ...
    self.DHTMLWindow                = ui.new( 'dhtml', self.p_dt_sub, 1     )
    :fill                           ( 'm', 10, 15, 5, 10                    )
    ...
    */
    ...
    self.DHTMLControlsBar           = ui.new( 'ctrls', self.p_dt_sub        )
    :top                            ( 'm', 0                                )
    :pos                            ( 0                                     )
    :html                           ( self.DHTMLWindow or ''                )

    /*
    *   attach window
    */

    local window                    = ui.get( self.DHTMLWindow              )
    :below                          ( self.DHTMLControlsBar                 )
...
function PANEL:SetURL( url )
    self.url = url
    self.DHTMLWindow:OpenURL( url )
    self.DHTMLControlsBar.AddressBar:SetText( url )
end
