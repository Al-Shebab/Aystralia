...
mod.language[ 'en' ] =
{
    ...
    rules_title                         = 'Rules & Network Policies',
    ...
    sys_ann_sl_confl_msg                = 'cfg.slider & cfg.announcements enabled. Disable one to avoid conflict',
