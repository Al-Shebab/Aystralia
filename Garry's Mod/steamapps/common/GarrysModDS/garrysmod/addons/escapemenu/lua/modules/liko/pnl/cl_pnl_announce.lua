...
function PANEL:Init( )
    ...
    */
    ...
    :top                            ( 'm', 10, 15, 0                        )
    :tall                           ( 30                                    )
    :textadv                        ( cfg.announcements.clrs.header_title, pref( 'ann_title' ), ln( 'sec_announcements' ) )
                                    ...
                                    :draw( function( s, w, h )
                                        ...
                                        draw.SimpleText( self.header, pref( 'ann_title' ), 30, h / 2, cfg.announcements.clrs.header_title, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER )
                                    end )
                                    ...
                                    if ( cfg.ads.webm.enabled ) then
                                        ...
                                        [[
                                            <body style='overflow: hidden; height: 100%; width: 100%;'>
                                                <video controls width=']] .. calc_sz_w .. [[' height=']] .. calc_sz_h .. [[' ]] .. autoplay .. [[ id='likovidbg'><source src=']] .. table.Random( cfg.ads.webm.urls ) .. [[' type='video/webm'></video>
                                            </body>
                                        ]])
                                        self.ads:RunJavascript( 'var vid = document.getElementById( "likovidbg" ); vid.volume = ' .. cfg.ads.webm.vol .. ';' )
...
ui:create( mod, 'announce', PANEL, 'pnl' )