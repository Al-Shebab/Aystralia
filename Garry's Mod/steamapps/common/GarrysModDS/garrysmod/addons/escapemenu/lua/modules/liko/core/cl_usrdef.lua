...
function mod.usrdef:Setup( data )
    ...
    local function setup( )
        ...
        pl.rlib.liko                = pl.rlib.liko or { }           -- subparent
        pl.rlib.liko.res_w          = ScrW( )                       -- stored screen resolution ( w )
        pl.rlib.liko.res_h          = ScrH( )                       -- stored screen resolution ( h )
        ...
        */
        ...
        bHasRan = true
        rhook.drop.gmod( 'Think', 'liko_usrdef_setup_think' )
    end
    rhook.new.gmod( 'Think', 'liko_usrdef_setup_think', setup )
...
rhook.new.gmod( 'OnScreenSizeChanged', 'liko_usrdef_res_change', usrdef_res_change )