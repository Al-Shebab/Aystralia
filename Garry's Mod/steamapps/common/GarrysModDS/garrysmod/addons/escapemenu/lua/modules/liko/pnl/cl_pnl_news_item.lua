...
function PANEL:Init( )
    ...
    */
    ...
    self:SetPos                     ( ScrW( ) - cfg.slider.width - 100, cfg.slider.height )
...
function PANEL:Render( )
    ...
    */
    ...
    :fill                           ( 'm', 0                                )
                                    ...
                                    :draw( function( s, w, h )
                                        ...
                                        draw.DrawText( self:GetHeader( ), pref( 'slider_header' ), w - 10, h - 55, clr_text_title, TEXT_ALIGN_RIGHT )
                                        draw.DrawText( self:GetHeaderSub( ), pref( 'slider_header_sub' ), w - 10, h - 27, clr_text_desc, TEXT_ALIGN_RIGHT )
                                    end )
    ...
    */
    ...
    :txt	                        ( self:GetBodyTitle( ), Color( 209, 155, 67, 255 ), pref( 'slider_body_title' ) )
    :ocnf                           ( true                                  )
    ...
    :canedit	                    ( false 				                )
    :scur	                        ( Color( 255, 255, 255, 255 ), 'beam'   )
    :txt	                        ( self:GetBodyMsg( ), Color( 255, 255, 255, 255 ), pref( 'slider_body_msg' ) )
    :ocnf                           ( true                                  )
...
ui:create( mod, 'news_item', PANEL, 'pnl' )