...
function PANEL:Init( )
    ...
    */
    ...
    self:SetPos                     ( ScrW( ) - cfg.slider.width - cfg.general.margin_left, ui:SmartScaleH( false, cfg.general.margin_top ) )
    ...
    */
    ...
    self.object                     = ui.rlib( mod, 'news_item', self, 1    )
    :fill                           ( 'm', 0                                )
    ...
    */
    ...
    for k, v in SortedPairs( populate_data ) do
        ...
        */
        ...
        if k == 1 then
            ...
            if ui:ok( self.object ) then
                ...
                self.object:SetBodyTitle   ( v.title            )
                self.object:SetBodyMsg     ( v.desc             )
        ...
        */
        ...
        self.b_slidesel.DoClick = function( s )
            ...
            timex.expire( 'liko_slider_sw_pause' )
            timex.pause( 'liko_slider_sw' )
            timex.create( 'liko_slider_sw_pause', cfg.slider.resume_delay or 30, 1, function( )
                timex.resume( 'liko_slider_sw' )
            end )
    ...
    timex.create( 'liko_slider_sw', cfg.slider.autosw_delay, 0, function( )
...
function PANEL:Resolution( )
    ...
    */
    ...
    :fill                           ( 'p', 10                               )
                                    ...
                                    :draw( function( s, w, h )
                                        design.rbox( 4, 0, 0, w, h, Color( 25, 25, 25, 200 ) )
    ...
    */
    ...
    :tall                           ( 25                                    )
                                    ...
                                    :draw( function( s, w, h )
                                        draw.SimpleText( ln( 'sys_res_err_title' ), pref( 'news_res_title' ), w / 2, h / 2, Color( 220, 220, 220, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
                                    end )
    ...
    */
    ...
    :font                           ( pref( 'news_res_btn_settings' )       )
    ...
    if ScrW( ) <= 1280 then
        ...
        if not ui:visible( self.p_resolution ) then
            if ScrW( ) > 640 then
                ...
                self:SetPos     ( ScrW( ) - cfg.general.reswarn_w - ( ScrW( ) < 800 and 20 or 100 ), ui:SmartScaleH( false, cfg.general.margin_top ) )
            end
        end
    else
