...
GM.Config.DisallowDrop = {
    ...
    ["csgo_karambit_gamma_doppler"] = true,
    ...
    ["csgo_karambit_black_laminate"] = true,
    ...
    ["csgo_huntsman_gamma_doppler"] = true,
    ...
    ["csgo_daggers_gamma_doppler"] = true,
    ["csgo_daggers_freehand"] = true,
...
GM.Config.PocketBlacklist = {
    ...
    ["gmod_wire_adv_emarker"] = true,
    ["gmod_wire_adv_input"] = true,
    ["gmod_wire_button"] = true,
    ["gmod_wire_cameracontroller"] = true,
    ["gmod_wire_cd_disk"] = true,
    ["gmod_wire_cd_lock"] = true,
    ["gmod_wire_cd_ray"] = true,
    ["gmod_wire_clutch"] = true,
    ["gmod_wire_colorer"] = true,
    ["gmod_wire_cpu"] = true,
    ["gmod_wire_damage_detector"] = true,
    ["gmod_wire_data_satellitedish"] = true,
    ["gmod_wire_data_store"] = true,
    ["gmod_wire_data_transferer"] = true,
    ["gmod_wire_dataplug"] = true,
    ["gmod_wire_dataport"] = true,
    ["gmod_wire_datarate"] = true,
    ["gmod_wire_datasocket"] = true,
    ["gmod_wire_detonator"] = true,
    ["gmod_wire_dhdd"] = true,
    ["gmod_wire_dual_input"] = true,
    ["gmod_wire_dynamic_button"] = true,
    ["gmod_wire_egp_emitter"] = true,
    ["gmod_wire_emarker"] = true,
    ["gmod_wire_exit_point"] = true,
    ["gmod_wire_explosive"] = true,
    ["gmod_wire_extbus"] = true,
    ["gmod_wire_eyepod"] = true,
    ["gmod_wire_forcer"] = true,
    ["gmod_wire_freezer"] = true,
    ["gmod_wire_friendslist"] = true,
    ["gmod_wire_fx_emitter"] = true,
    ["gmod_wire_gate"] = true,
    ["gmod_wire_gimbal"] = true,
    ["gmod_wire_gps"] = true,
    ["gmod_wire_gpulib_controller"] = true,
    ["gmod_wire_grabber"] = true,
    ["gmod_wire_graphics_tablet"] = true,
    ["gmod_wire_gyroscope"] = true,
    ["gmod_wire_hdd"] = true,
    ["gmod_wire_holoemitter"] = true,
    ["gmod_wire_hologram"] = true,
    ["gmod_wire_hologrid"] = true,
    ["gmod_wire_hoverball"] = true,
    ["gmod_wire_hydraulic"] = true,
    ["gmod_wire_igniter"] = true,
    ["gmod_wire_indicator"] = true,
    ["gmod_wire_input"] = true,
    ["gmod_wire_keypad"] = true,
    ["gmod_wire_lamp"] = true,
    ["gmod_wire_las_receiver"] = true,
    ["gmod_wire_latch"] = true,
    ["gmod_wire_lever"] = true,
    ["gmod_wire_light"] = true,
    ["gmod_wire_locator"] = true,
    ["gmod_wire_motor"] = true,
    ["gmod_wire_nailer"] = true,
    ["gmod_wire_numpad"] = true,
    ["gmod_wire_oscilloscope"] = true,
    ["gmod_wire_output"] = true,
    ["gmod_wire_pixel"] = true,
    ["gmod_wire_plug"] = true,
    ["gmod_wire_pod"] = true,
    ["gmod_wire_radio"] = true,
    ["gmod_wire_ranger"] = true,
    ["gmod_wire_relay"] = true,
    ["gmod_wire_screen"] = true,
    ["gmod_wire_sensor"] = true,
    ["gmod_wire_simple_explosive"] = true,
    ["gmod_wire_socket"] = true,
    ["gmod_wire_soundemitter"] = true,
    ["gmod_wire_spawner"] = true,
    ["gmod_wire_speedometer"] = true,
    ["gmod_wire_target_finder"] = true,
    ["gmod_wire_teleporter"] = true,
    ["gmod_wire_textentry"] = true,
    ["gmod_wire_textreceiver"] = true,
    ...
    ["gmod_wire_twoway_radio"] = true,
    ["gmod_wire_user"] = true,
    ["gmod_wire_value"] = true,
    ["gmod_wire_vectorthruster"] = true,
    ["gmod_wire_vehicle"] = true,
    ["gmod_wire_watersensor"] = true,
    ["gmod_wire_waypoint"] = true,
    ["gmod_wire_weight"] = true,
