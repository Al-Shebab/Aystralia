...
TEAM_POLICE_OFFICER = DarkRP.createJob("Police Officer", {
    ...
    weapons = {"m9k_usp", "weapon_cuff_police", "arrest_stick", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker"},
...
TEAM_POLICE_CHIEF = DarkRP.createJob("Police Chief", {
    ...
    description = [[Protect and serve. Can not base, raid or mug.]],
    weapons = {"weapon_cuff_police", "arrest_stick", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "m9k_mp5", "door_ram"},
...
TEAM_SWAT = DarkRP.createJob("SWAT", {
    ...
    weapons = {"weapon_cuff_police", "arrest_stick", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "m9k_mp5"},
    command = "TEAM_SWAT",
    max = 2,
    salary = 9000,
    admin = 0,
...
TEAM_SWAT_HEAVY = DarkRP.createJob("Swat Heavy", {
    ...
    weapons = {"weapon_cuff_police", "arrest_stick", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "m9k_ares_shrike"},
...
TEAM_SWAT_MARKSMAN = DarkRP.createJob("Swat Marksman", {
    ...
    weapons = {"weapon_cuff_police", "arrest_stick", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "m9k_intervention"},
...
TEAM_SWAT_MEDIC = DarkRP.createJob("Swat Medic", {
    ...
    weapons = {"weapon_cuff_police", "arrest_stick", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "med_kit", "m9k_mp5"},
...
TEAM_SWAT_LEADER = DarkRP.createJob("Swat Leader", {
    ...
    weapons = {"weapon_cuff_police", "arrest_stick", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "m9k_m416"},
