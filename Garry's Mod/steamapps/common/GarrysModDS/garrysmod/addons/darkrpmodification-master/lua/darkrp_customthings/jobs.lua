...
TEAM_SOWAKA = DarkRP.createJob("Noot-Noot", {
    ...
    weapons = {"prokeypadcracker", "pickpocket", "pro_lockpick", "unarrest_stick", "m9k_m98b", "med_kit", "weapon_nomad", "weapon_armorkit"},
    command = "TEAM_SOWAKA",
    max = 1,
    salary = 8000,
    admin = 0,
...
TEAM_KERMIT = DarkRP.createJob("Chicken Dicken", {
    ...
    weapons = {"prokeypadcracker", "pickpocket", "pro_lockpick", "unarrest_stick", "m9k_g36", "invisibility_cloak"},
    command = "TEAM_KERMIT",
    max = 1,
    salary = 15000,
    admin = 0,
