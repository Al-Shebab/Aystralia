...
TEAM_TERRORIST = DarkRP.createJob("Terrorist", {
    ...
    description = [[Can shoot up an entire city, but only once. May only advert terror once every hour. Donator ONLY. CAN NOT TERROR INSIDE OF CASINO]],
    weapons = {"m9k_ak47"},
...
TEAM_KERMIT = DarkRP.createJob("Zoidberg", {
    ...
    description = [[kiss me bruh | Thief]],
    weapons = {"prokeypadcracker", "pickpocket", "pro_lockpick", "unarrest_stick", "m9k_fg42", "weapon_armorkit", "weapon_spraymhs"},
    command = "TEAM_KERMIT",
    max = 1,
    salary = 2000,
    admin = 0,
