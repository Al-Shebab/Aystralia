...
TEAM_POLICE_OFFICER = DarkRP.createJob("Police Officer", {
    ...
    weapons = {"m9k_usp", "weapon_cuff_police", "arrest_stick", "stungun", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker"},
...
TEAM_POLICE_CHIEF = DarkRP.createJob("Police Chief", {
    ...
    description = [[Protect and serve. Can not base, raid or mug.]],
    weapons = {"weapon_cuff_police", "arrest_stick", "stungun", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "m9k_mp5", "door_ram"},
...
TEAM_SWAT = DarkRP.createJob("SWAT", {
    ...
    weapons = {"weapon_cuff_police", "arrest_stick", "stungun", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "m9k_mp5"},
    command = "TEAM_SWAT",
    max = 2,
    salary = 9000,
    admin = 0,
...
TEAM_SWAT_HEAVY = DarkRP.createJob("Swat Heavy", {
    ...
    weapons = {"weapon_cuff_police", "arrest_stick", "stungun", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "m9k_ares_shrike"},
...
TEAM_SWAT_MARKSMAN = DarkRP.createJob("Swat Marksman", {
    ...
    weapons = {"weapon_cuff_police", "arrest_stick", "stungun", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "m9k_intervention"},
...
TEAM_SWAT_MEDIC = DarkRP.createJob("Swat Medic", {
    ...
    weapons = {"weapon_cuff_police", "arrest_stick", "stungun", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "med_kit", "m9k_mp5"},
...
TEAM_SWAT_LEADER = DarkRP.createJob("Swat Leader", {
    ...
    weapons = {"weapon_cuff_police", "arrest_stick", "stungun", "door_ram", "unarrest_stick", "stunstick" , "weaponchecker", "m9k_m416"},
...
TEAM_HACKER = DarkRP.createJob("Hacker", {
    ...
    weapons = {"keypad_cracker","lockpick", "pickpocket"},
    command = "TEAM_HACKER",
    max = 4,
    salary =750,
    admin = 0,
...
TEAM_SONIC = DarkRP.createJob("Sonic", {
    ...
    weapons = {"m9k_dragunov", "pro_lockpick", "prokeypadcracker", "pickpocket", "invisibility_cloak"},
    command = "TEAM_SONIC",
    max = 1,
    salary = 8000,
    admin = 0,
...
TEAM_SOWAKA = DarkRP.createJob("Noot-Noot", {
    ...
    weapons = {"prokeypadcracker", "pickpocket", "pro_lockpick", "m9k_browningauto5", "med_kit", "weapon_nomad", "weapon_armorkit"},
    command = "TEAM_SOWAKA",
    max = 1,
    salary = 8000,
    admin = 0,
...
TEAM_2B = DarkRP.createJob("2B", {
    ...
    weapons = {"prokeypadcracker", "pickpocket", "pro_lockpick", "m9k_dragunov", "climb_swep2"},
    command = "TEAM_2B",
    max = 1,
    salary = 8000,
    admin = 0,
...
TEAM_PICKLE_RICK = DarkRP.createJob("Pickle Rick", {
    ...
    weapons = {"prokeypadcracker", "pickpocket", "pro_lockpick", "invisibility_cloak", "m9k_browningauto5"},
...
TEAM_RAT_KING = DarkRP.createJob("Rat King", {
    ...
    weapons = {"prokeypadcracker", "pickpocket", "pro_lockpick", "invisibility_cloak", "m9k_honeybadger"},
