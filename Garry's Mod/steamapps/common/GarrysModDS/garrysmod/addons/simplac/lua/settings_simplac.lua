...
-- DO NOT ENABLE
-- DO NOT ENABLE
-- Simplac.settings.MouseCheck1 = false -- MC = WILL 99.9% CAUSE FALSE DETECTIONS Mouse Check ( against aimbots etc. )
-- Simplac.settings.Aimbot_SCheck = false -- AS = WILL 99.9% CAUSE FALSE DETECTIONS  Statistical aimbot check (also against aimbots etc.)
-- DO NOT ENABLE
-- DO NOT ENABLE
-- DO NOT ENABLE