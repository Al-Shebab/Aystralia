...
/*
	Ghosting 
*/
config.ghostColor 					= Color(200, 30, 30, 200);
...
/*
	Forced Physics Props 
	
	Props that should always have physics regardless of settings
*/
config.forcedPhysics = {};
config.forcedPhysics["models/props_phx/misc/soccerball.mdl"] 	= true;
config.forcedPhysics["models/xqm/rails/gumball_1.mdl"] 			= true;
config.forcedPhysics["models/xqm/rails/trackball_1.mdl"] 		= true;
...
config.lang.propPhysics				= "Allow Prop Physics";
config.lang.antiFadingDoor			= "Anti Fading Door Exploit";
