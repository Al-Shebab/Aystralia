...
function ENT:DrawInfo()
	...
	local Ang = Angle(0, LocalPlayer():EyeAngles().y - 90, LocalPlayer():EyeAngles().z + 90)
	local rTable = {}

	rTable["Coal"] = {
		a = math.Round(self:GetCoal(), 1),
		c = zrmine.default_colors["Coal"]
	}

	rTable["Iron"] = {
		a = math.Round(self:GetIron(), 1),
		c = zrmine.default_colors["Iron"]
	}

	rTable["Bronze"] = {
		a = math.Round(self:GetBronze(), 1),
		c = zrmine.default_colors["Bronze"]
	}

	rTable["Silver"] = {
		a = math.Round(self:GetSilver(), 1),
		c = zrmine.default_colors["Silver"]
	}

	rTable["Gold"] = {
		a = math.Round(self:GetGold(), 1),
		c = zrmine.default_colors["Gold"]
	}
