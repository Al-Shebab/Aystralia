...
zrmine.Swep_BuildItems = {
	[1] = {name = "Crusher" ,class = "zrms_crusher", model = "models/zerochain/props_mining/zrms_crusher.mdl",icon = Material("materials/entities/zrms_crusher.png", "smooth")},
	[2] = {name = "Conveyorbelt - Normal" ,class = "zrms_conveyorbelt_n", model = "models/zerochain/props_mining/zrms_conveyorbelt_normal.mdl",icon = Material("materials/entities/zrms_conveyorbelt_n.png", "smooth")},
	[3] = {name = "Conveyorbelt - Small" ,class = "zrms_conveyorbelt_s", model = "models/zerochain/props_mining/zrms_conveyorbelt_small.mdl",icon = Material("materials/entities/zrms_conveyorbelt_s.png", "smooth")},
	[4] = {name = "Conveyorbelt - Left" ,class = "zrms_conveyorbelt_c_left", model = "models/zerochain/props_mining/zrms_conveyorbelt_curved_left.mdl",icon = Material("materials/entities/zrms_conveyorbelt_c_left.png", "smooth")},
	[5] = {name = "Conveyorbelt - Right" ,class = "zrms_conveyorbelt_c_right", model = "models/zerochain/props_mining/zrms_conveyorbelt_curved.mdl",icon = Material("materials/entities/zrms_conveyorbelt_c_right.png", "smooth")},

	[6] = {name = "Conveyorbelt - Inserter" ,class = "zrms_inserter", model = "models/zerochain/props_mining/zrms_inserter.mdl",icon = Material("materials/entities/zrms_inserter.png", "smooth")},
	[7] = {name = "Conveyorbelt - Splitter" ,class = "zrms_splitter", model = "models/zerochain/props_mining/zrms_conveyorbelt_splitter.mdl",icon = Material("materials/entities/zrms_splitter.png", "smooth")},

	[8] = {name = "Refinery - Coal" ,class = "zrms_refiner_coal", model = "models/zerochain/props_mining/zrms_refiner.mdl",icon = Material("materials/entities/zrms_refiner_coal.png", "smooth")},
	[9] = {name = "Refinery - Iron" ,class = "zrms_refiner_iron", model = "models/zerochain/props_mining/zrms_refiner.mdl",icon = Material("materials/entities/zrms_refiner_iron.png", "smooth")},
	[10] = {name = "Refinery - Bronze" ,class = "zrms_refiner_bronze", model = "models/zerochain/props_mining/zrms_refiner.mdl",icon = Material("materials/entities/zrms_refiner_bronze.png", "smooth")},
	[11] = {name = "Refinery - Silver" ,class = "zrms_refiner_silver", model = "models/zerochain/props_mining/zrms_refiner.mdl",icon = Material("materials/entities/zrms_refiner_silver.png", "smooth")},
	[12] = {name = "Refinery - Gold" ,class = "zrms_refiner_gold", model = "models/zerochain/props_mining/zrms_refiner.mdl",icon = Material("materials/entities/zrms_refiner_gold.png", "smooth")},

	[13] = {name = "Filter - Coal" ,class = "zrms_sorter_coal", model = "models/zerochain/props_mining/zrms_conveyorbelt_sorter.mdl",icon = Material("materials/entities/zrms_sorter_coal.png", "smooth")},
	[14] = {name = "Filter - Iron" ,class = "zrms_sorter_iron", model = "models/zerochain/props_mining/zrms_conveyorbelt_sorter.mdl",icon = Material("materials/entities/zrms_sorter_iron.png", "smooth")},
	[15] = {name = "Filter - Bronze" ,class = "zrms_sorter_bronze", model = "models/zerochain/props_mining/zrms_conveyorbelt_sorter.mdl",icon = Material("materials/entities/zrms_sorter_bronze.png", "smooth")},
	[16] = {name = "Filter - Silver" ,class = "zrms_sorter_silver", model = "models/zerochain/props_mining/zrms_conveyorbelt_sorter.mdl",icon = Material("materials/entities/zrms_sorter_silver.png", "smooth")},
	[17] = {name = "Filter - Gold" ,class = "zrms_sorter_gold", model = "models/zerochain/props_mining/zrms_conveyorbelt_sorter.mdl",icon = Material("materials/entities/zrms_sorter_gold.png", "smooth")},
}
