...
function ENT:StartTouch(ent)
	...
	if (ent:GetClass() == "zrms_bar_bronze" or ent:GetClass() == "zrms_bar_iron" or ent:GetClass() == "zrms_bar_silver" or ent:GetClass() == "zrms_bar_gold" or ent:GetClass() == "zrms_bar") and self.BarCount < 12 and ent.zrms_added == false then
