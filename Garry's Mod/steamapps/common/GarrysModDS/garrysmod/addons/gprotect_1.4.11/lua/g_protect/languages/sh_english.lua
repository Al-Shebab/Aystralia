if SERVER then
	slib.setLang("gprotect", "en", "colliding-too-much", "%s's entities are colliding too much!")
	...
	slib.setLang("gprotect", "en", "attempted-blackout", "%s has attempted the blackout exploit!")
...
elseif CLIENT then
	...
	slib.setLang("gprotect", "en", "general_removeDisconnectedPlayersEntities", "Remove disconnect players entities")
	slib.setLang("gprotect", "en", "general_removeDisconnectedPlayersEntities_tooltip", "This removes disconnected players entities on timer (If -1 it will be disabled.)")
	slib.setLang("gprotect", "en", "general_disconnectedEntitiesBypass", "Disconnected entities bypass")
	slib.setLang("gprotect", "en", "general_disconnectedEntitiesBypass_tooltip", "The entities in this list will bypass the entity removal process!")
	...
	slib.setLang("gprotect", "en", "general_maxModelSize", "Max model size")
	slib.setLang("gprotect", "en", "general_maxModelSize_tooltip", "If this is above 0 it will remove bigger props right after they are spawned.")
	...
	slib.setLang("gprotect", "en", "damage_worldPlayerDamage_tooltip", "If this is ticked then players can receive damage from blacklisted entities.")
	...
	slib.setLang("gprotect", "en", "anticollide_protectSpawnedProps_tooltip", "Should we protect Spawned Props? (0 = Disabled, 1 = Ghost, 2 = Freeze, 3 = Remove")
	...
	slib.setLang("gprotect", "en", "spawnrestriction_blockedSENTs", "Blocked SENTs")
	slib.setLang("gprotect", "en", "spawnrestriction_blockedSENTs_tooltip", "Place classnames of entities that should never be spawned in here!")
	slib.setLang("gprotect", "en", "spawnrestriction_blockedEntityIsBlacklist", "Blocked classes is a blacklist")
	slib.setLang("gprotect", "en", "spawnrestriction_blockedEntityIsBlacklist_tooltip", "If ticked it will make the classes in the list blocked from being spawned, else you can only spawn those classes.")
	...
	slib.setLang("gprotect", "en", "spawnrestriction_blockedModelsisBlacklist_tooltip", "If ticked it will make the models in the list blocked from being spawned, else you can only spawn those models.")
	...
	slib.setLang("gprotect", "en", "toolgunsettings_targetWorld_tooltip", "This means that they can target world entities and props! (Add usergroups in here to allow them, * means everyone!)")
	slib.setLang("gprotect", "en", "toolgunsettings_targetPlayerOwned", "Can target player owned entities")
	slib.setLang("gprotect", "en", "toolgunsettings_targetPlayerOwned_tooltip", "This means that they can target players entities and props! (Add usergroups in here to allow them, * means everyone!)")
	...
	slib.setLang("gprotect", "en", "toolgunsettings_groupToolRestrictions_tooltip", "Configure tool restrictions by tool.")
	...
	slib.setLang("gprotect", "en", "physgunsettings_targetWorld_tooltip", "This means that they can target world entities and props! (Add usergroups in here to allow them, * means everyone!)")
	slib.setLang("gprotect", "en", "physgunsettings_targetPlayerOwned", "Can target player owned entities")
	slib.setLang("gprotect", "en", "physgunsettings_targetPlayerOwned_tooltip", "This means that they can target players entities and props! (Add usergroups in here to allow them, * means everyone!)")
	...
	slib.setLang("gprotect", "en", "physgunsettings_blockedEntities_tooltip", "Add entities into this and it wont be physgunable by anyone that isnt in the bypassgroup.")
	...
	slib.setLang("gprotect", "en", "gravitygunsettings_targetWorld_tooltip", "This means that they can target world entities and props! (Add usergroups in here to allow them, * means everyone!)")
	slib.setLang("gprotect", "en", "gravitygunsettings_targetPlayerOwned", "Can target player owned entities")
	slib.setLang("gprotect", "en", "gravitygunsettings_targetPlayerOwned_tooltip", "This means that they can target players entities and props! (Add usergroups in here to allow them, * means everyone!)")
	...
	slib.setLang("gprotect", "en", "gravitygunsettings_blockedEntities_tooltip", "Add entities into this and it wont be physgunable by anyone that isnt in the bypassgroup.")
	...
	slib.setLang("gprotect", "en", "canpropertysettings_targetWorld_tooltip", "This means that they can target world entities and props! (Add usergroups in here to allow them, * means everyone!)")
	slib.setLang("gprotect", "en", "canpropertysettings_targetPlayerOwned", "Can target player owned entities")
	slib.setLang("gprotect", "en", "canpropertysettings_targetPlayerOwned_tooltip", "This means that they can target players entities and props! (Add usergroups in here to allow them, * means everyone!)")
	...
	slib.setLang("gprotect", "en", "canpropertysettings_blockedPropertiesisBlacklist_tooltip", "If ticked it will make the properties in the list will be blocked from being used, else you can only use those properties.")
	...
	slib.setLang("gprotect", "en", "advdupe2_PreventUnfreezeAll_tooltip", "Prevent people from unfreezing all props. (1 = Prevent Spawning, 2 = Spawn But Fix)")
	...
	slib.setLang("gprotect", "en", "miscs_NoBlackoutGlitch", "Prevent blackout exploit")
	slib.setLang("gprotect", "en", "miscs_NoBlackoutGlitch_tooltip", "Int this will prevent the 'pp/copy' exploit(1 = Notify, 2 = kick, 3 = ban).")
