...
--------------------------------]]
	...
	hud_scale = "HUD Scale",
	hud_rounding = "HUD Rounding",
	hud_opacity = "HUD Opacity",

	hud_minimal = "Enable Minimal Mode",
	hud_crashscreen = "Enable Crash Screen",
	hud_blur = "Enable Blur",

	hud_rolecolor = "Team color for the header (set your own color below if disabled)",
	custom_header_color = "Custom header color:",

	level_mode = "Level Panel Mode",
	laws_mode = "Laws Panel Mode",
	wantedlist_mode = "Wanted List Mode",

	copy_settings = "Copy settings to clipboard",
