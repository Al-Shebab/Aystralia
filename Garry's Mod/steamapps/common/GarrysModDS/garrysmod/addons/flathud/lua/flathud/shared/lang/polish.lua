...
--------------------------------]]
	...
	hud_scale = "Rozmiar HUD'u",
	hud_rounding = "Zaokrąglenie HUD'u",
	hud_opacity = "Przejrzystość HUD'u",

	hud_minimal = "Włacz tryb Mini",
	hud_crashscreen = "Włącz Crash Screen",
	hud_blur = "Włącz efekt rozmycia",

	hud_rolecolor = "Kolor teamu dla HUD'u (ustaw własny kolor poniżej jeśli wyłączone)",
	custom_header_color = "Własny kolor HUD'u:",

	level_mode = "Tryb panelu poziomu",
	laws_mode = "Tryb panelu praw",
	wantedlist_mode = "Tryb listy poszukiwanych",

	copy_settings = "Skopiuj ustawienia do schowka",
...
--------------------------------]]
	...
	team_door_access = "Dostep: %J job(s)",

	owner_unknown = "Właściciel: Unknown",

	door_coowners = "Współwłaściciela:",
