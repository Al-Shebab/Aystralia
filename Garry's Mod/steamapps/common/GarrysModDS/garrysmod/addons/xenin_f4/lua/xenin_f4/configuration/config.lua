...
cfg:AddStaff("trial-moderator", "Trial Moderator", Color(24, 249, 255), 100)
cfg:AddStaff("moderator", "Moderator", Color(74, 255, 121), 102)
cfg:AddStaff("senior-moderator", "Senior Moderator", Color(148, 255, 87), 104)
cfg:AddStaff("admin", "Admin", Color(226, 255, 68), 106)
cfg:AddStaff("senior-admin", "Senior Admin", Color(255, 180, 0), 108)
cfg:AddStaff("staff-manager", "Staff Manager", Color(255, 101, 101), 109)
cfg:AddStaff("donator-trial-moderator", "Trial Moderator", Color(24, 249, 255), 101)
cfg:AddStaff("donator-moderator", "Moderator", Color(74, 255, 121), 103)
cfg:AddStaff("donator-senior-moderator", "Senior Moderator", Color(148, 255, 87), 105)
cfg:AddStaff("donator-admin", "Admin", Color(226, 255, 68), 107)
