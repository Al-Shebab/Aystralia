...
TCF.Config.PayPerPackMin = 10000 -- How much should each cocaine pack be worth? Minimum value (without any donator bonuses)
TCF.Config.PayPerPackMax = 15000 -- How much should each cocaine pack be worth? Maximum value (without any donator bonuses)
