...
-- TEAM CONFIGURATION
CH_SupplyCrate.Config.RequiredTeams = {
	"Police Officer",
	"Police Chief",
	"SWAT",
	"Swat Heavy",
...
CH_SupplyCrate.Config.GovernmentTeams = {
	"Police Officer",
	"Police Chief",
	"SWAT",
	"Swat Heavy",
...
CH_SupplyCrate.Config.MoneyOnTime = 15000 -- This is the amount of money to be added to the supply crate every x minutes/seconds. Defined by the setting above. [Default = 1250]
