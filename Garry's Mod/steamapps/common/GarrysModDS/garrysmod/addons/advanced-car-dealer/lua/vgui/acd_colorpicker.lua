...
function PANEL:Init( )
    ...
    self.m_colorwheel = vgui.Create( 'CarDealer.ColorWheel', self )
    ...
    --     -- w, h = x + w, y + h
    --     KVS:DrawLinearGradient( x, y, w, h, Color( 0, 0, 0, 0 ), this.m_colorwheel:GetColor( true ) )
    -- end
    ...
    self.m_darknessslider = vgui.Create( 'DNumSlider', self )
    self.m_darknessslider:SetMin( 0 )
    self.m_darknessslider:SetMax( 1 )
    self.m_darknessslider:SetText( "" )
    self.m_darknessslider.Label:Dock( FILL )
    -- function self.m_darknessslider:DrawSlideBar( x, y, w, h )
    --     local screen_x, screen_y = self:LocalToScreen( )
    --     x, y = screen_x + x, screen_y + y
    --     -- KVS:DrawLinearGradient( x, y, w, h, this.m_colorwheel:GetColor( true ), Color( 0, 0, 0 ) ) -- TODO
    -- end
...
function PANEL:PerformLayout( w, h )
    ...
    self.m_darknessslider:SetSize( w, h * 0.05 )
...
vgui.Register( 'CarDealer.ColorPicker', PANEL, 'DPanel' )
