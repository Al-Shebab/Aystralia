...
elseif CLIENT then
	...
	slib.setLang("gprotect", "pl", "general_removeDisconnectedPlayersEntities", "Usuń odłączone jednostki graczy")
	slib.setLang("gprotect", "pl", "general_removeDisconnectedPlayersEntities_tooltip", "Spowoduje to usunięcie odłączonych graczy na liczniku (jeśli -1 zostanie wyłączone).")
	...
	slib.setLang("gprotect", "pl", "general_maxModelSize", "Maksymalny rozmiar modelu")
	slib.setLang("gprotect", "pl", "general_maxModelSize_tooltip", "Jeśli jest powyżej 0, spowoduje to usunięcie większych rekwizytów zaraz po ich pojawieniu się.")
	...
	slib.setLang("gprotect", "pl", "spawnrestriction_blockedSENTs", "Blocked SENTs")
	slib.setLang("gprotect", "pl", "spawnrestriction_blockedSENTs_tooltip", "Umieść tutaj nazwy klas bytów, które nigdy nie powinny się pojawiać!")
	slib.setLang("gprotect", "pl", "spawnrestriction_blockedEntityIsBlacklist", "Zablokowane klasy to czarna lista")
	slib.setLang("gprotect", "pl", "spawnrestriction_blockedEntityIsBlacklist_tooltip", "Zaznaczenie tej opcji spowoduje, że klasy z listy będą blokowane przed tworzeniem, w przeciwnym razie możesz tworzyć tylko te klasy.")
