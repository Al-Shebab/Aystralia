...
elseif CLIENT then
	...
	slib.setLang("gprotect", "fr", "general_removeDisconnectedPlayersEntities", "Supprimer les entités des joueurs déconnécter")
	slib.setLang("gprotect", "fr", "general_removeDisconnectedPlayersEntities_tooltip", "Cela supprime les entités des joueurs déconnectés avec une minuterie(Si -1 il sera désactivé.)")
