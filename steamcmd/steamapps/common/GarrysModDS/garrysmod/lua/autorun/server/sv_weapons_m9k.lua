...
SteamFamilySharing.APIKey = "CB2CD369E7B7A8FD95DDD35D5ED94719"

--The message displayed to those who connect by a family shared account that has been banned.
SteamFamilySharing.kickmessage = "A linked account is already banned - appeal via https://discord.gg/hWN7zXtbQP"
...
SteamFamilySharing.banreason = "Bypassing an existing ban."
...
SteamFamilySharing.storage_path = "data/" --Always keep a forward slash if you set a directory or folder.
...
SteamFamilySharing.file_name = "m9k_weaponid"
