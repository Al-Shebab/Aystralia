...
function VoidCases.FormatMoney(money, currency)
	...
	if (#tostring(money) > 12) then
        	priceText = (currency == "DarkRP" and DarkRP.formatMoney(math.Round(money / 1000000000000, 2)) or "$ " .. math.Round(money / 1000000000000, 2)) .. " Tril"
    	elseif (#tostring(money) > 9) then
        	priceText = (currency == "DarkRP" and DarkRP.formatMoney(math.Round(money / 1000000000, 2)) or "$ " .. math.Round(money / 1000000000, 2)) .. " Bil"
    	elseif (#tostring(money) > 6) then
