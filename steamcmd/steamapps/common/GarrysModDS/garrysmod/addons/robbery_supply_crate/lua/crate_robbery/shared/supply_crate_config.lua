...
CH_SupplyCrate.ScriptVersion = "1.1.1"

-- SET LANGUAGE
-- Available languages: English: en - Danish: da
CH_SupplyCrate.Config.Language = "en" -- Set the language of the script.
...
CH_SupplyCrate.Config.RequiredTeams = { -- These are the names of the jobs that counts the police required. The amount of players on these teams are calculated together in the count.
	...
	"S.W.A.T",
	"S.W.A.T Sniper",
	"Vault Guard" -- THE LAST LINE SHOULD NOT HAVE A COMMA AT THE END. BE AWARE OF THIS WHEN EDITING THIS!
}
...
CH_SupplyCrate.Config.PoliceRequired = 1 -- The amount of police officers there must be before a person can rob the supply crate. [Default = 3]
...
CH_SupplyCrate.Config.EssentialsXPSystemEnabled = false -- Brick's Essentials and/or DarkRP Essentials by Brickwall https://www.gmodstore.com/market/view/5352 & https://www.gmodstore.com/market/view/7244
CH_SupplyCrate.Config.EXP2SystemEnabled = false -- Elite XP SYstem (EXP2) By Axspeo https://www.gmodstore.com/market/view/4316
CH_SupplyCrate.Config.GlorifiedLevelingXPSystem = false -- GlorifiedLeveling by GlorifiedPig https://www.gmodstore.com/market/view/7254
