...
Configuration.InformationView       = { "trial-moderator", "moderator", "senior-moderator", "administrator", "senior-administrator", "staff-manager", "superadmin" }
...
Configuration.CommandBanReason      = "You have received an instant 1 day ban - Appeal via https://discord.gg/hWN7zXtbQP"
...
Configuration.CustomUserTag["STEAM_0:0:1"]       = { Tag = "Custom Input", TagColor = Color( 121,122,123 ) }
...
Configuration.AllowedGoto           = { "trial-moderator", "moderator", "senior-moderator", "administrator", "senior-administrator", "staff-manager", "superadmin" }
-- Who has access to bring
Configuration.AllowedBring          = { "trial-moderator", "moderator", "senior-moderator", "administrator", "senior-administrator", "staff-manager", "superadmin" }
-- Who has access to spectate
Configuration.AllowedSpectate       = { "trial-moderator", "moderator", "senior-moderator", "administrator", "senior-administrator", "staff-manager", "superadmin" }
-- Who has access to freeze
Configuration.AllowedFreeze         = { "trial-moderator", "moderator", "senior-moderator", "administrator", "senior-administrator", "staff-manager", "superadmin" }
-- Who has access to kick
Configuration.AllowedKick           = { "trial-moderator", "moderator", "senior-moderator", "administrator", "senior-administrator", "staff-manager", "superadmin" }
-- Who has access to ban
Configuration.AllowedBan            = { "trial-moderator", "moderator", "senior-moderator", "administrator", "senior-administrator", "staff-manager", "superadmin" }
...
Configuration.IncognitoAccess       = { "senior-administrator", "staff-manager", "superadmin" }
-- Who can see who is incognito mode?
Configuration.IncognitoVision       = { "senior-administrator", "staff-manager", "superadmin" }
