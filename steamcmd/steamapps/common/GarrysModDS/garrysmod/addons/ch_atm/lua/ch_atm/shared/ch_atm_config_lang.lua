...
CH_ATM.Config.Lang["Failed to detect SlownLS ATM on the server!"] = {
	["en"] = "Failed to detect SlownLS ATM on the server!",
	["fr"] = "Échec de la détection du 'SlownLS ATM' sur le serveur !",
	["da"] = "Kunne ikke registrere SlownLS ATM på serveren!",
	["de"] = "SlownLS ATM konnte auf dem Server nicht erkannt werden!",
	["pl"] = "Nie udało się wykryć bankomatu SlownLS na serwerze!",
	["ru"] = "Не удалось обнаружить банкомат SlownLS на сервере!",
	["es"] = "¡No se pudo detectar el cajero automático SlownLS en el servidor!",
	["pt"] = "",
	["cn"] = "",
	["tr"] = "Sunucuda SlownLS ATM algılanamadı!",
	["no"] = "",
}
...
CH_ATM.Config.Lang["An administrator has initiated an emergency lockdown on all ATMs in the city!"] = {
	...
	["fr"] = "Un administrateur à initié le vérouillage d'urgence sur tout les ATM de la ville!",
...
CH_ATM.Config.Lang["Cancel emergency ATM lockdown"] = {
	...
	["fr"] = "Annuler le vérouillage de tout les ATM",
...
CH_ATM.Config.Lang["Failed to detect Blue's ATM on the server!"] = {
	["en"] = "Failed to detect Blue's ATM on the server!",
	["fr"] = "Échec de la détection des Blues ATM sur le serveur !",
	["da"] = "Kunne ikke registrere Blue's ATM på serveren!",
	["de"] = "Der Geldautomat von Blue konnte auf dem Server nicht erkannt werden!",
	["pl"] = "Nie udało się wykryć bankomatu Blue na serwerze!",
	["ru"] = "Не удалось обнаружить банкомат Блю на сервере!",
	["es"] = "¡No se pudo detectar BluesATM en el servidor!",
	["pt"] = "",
	["cn"] = "",
	["tr"] = "Sunucuda Blue'nun ATM'si algılanamadı!",
	["no"] = "",
}
