...
--[[
	Default Config
--]]
CH_ATM.Config.AccountStartMoney = 50000 -- How much money is there on a bank account when it's created?
...
CH_ATM.Config.SendPaycheckToBank = true -- If this is enabled then their paycheck will be sent directly to their bank account instead of wallet.
...
CH_ATM.Config.EnableCustomAdminGroups = true -- Normally it just checks IsAdmin that works with all admin mods. If you want to specify your own usergroups then you can enable this.
