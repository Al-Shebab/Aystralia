...
elseif CLIENT then
	...
	slib.setLang("gprotect", "en", "gravitygunsettings_blockedEntities_tooltip", "Add entities into this and it cant be picked up by anyone that isnt in the bypassgroup.")
