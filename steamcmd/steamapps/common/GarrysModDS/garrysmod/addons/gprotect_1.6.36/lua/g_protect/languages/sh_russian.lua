...
elseif CLIENT then
	...
	slib.setLang("gprotect", "ru", "general_maxModelSize_tooltip", "Если больше 0, то более крупные пропы будут удалены сразу после появления")
	...
	slib.setLang("gprotect", "ru", "spawnrestriction_blockedSENTs_tooltip", "Список энтити, которые запрещено спавнить")
	slib.setLang("gprotect", "ru", "spawnrestriction_blockedEntityIsBlacklist", "Заблокированные энтити это чёрный список")
	slib.setLang("gprotect", "ru", "spawnrestriction_blockedEntityIsBlacklist_tooltip", "Если этот флажок установлен, энтити в списке будут заблокированы для спавна, иначе можно будет спавнить только эти энтити")
